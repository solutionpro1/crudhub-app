    ...
    <div className="min-h-screen bg-gray-100 font-sans pb-20">
      ...
      <div className="max-w-7xl mx-auto px-6 mt-8 space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200"><p className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Total Platform Value</p><h3 className="text-3xl font-black text-gray-900">â‚¦{estimatedRevenue.toLocaleString()}</h3><p className="text-xs text-green-600 font-bold mt-2">Estimated MRR</p></div>
